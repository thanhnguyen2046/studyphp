...
<section class="noidungtin">
	<div class="container">
		<div class="row">
			<div class="col-sm-9">
				<?php foreach ($newsDetail as $key => $value) { ?>
					<div class="mottinchuan mb-3  wow  fadeInUp fontroboto">

						<img src="<?= $value['image'] ?>" alt="">
						<a href="" class="tieudetin1 fontoswarld"><?= $value['title'] ?></a>
						<div class="ngaythang1"><?= date('d/m/Y - G:i - A', $value['created_at']) ?> <span class="vang"><?= $value['category_name'] ?></span></div>
						<?= $value['content'] ?>
				...
				<h3>Relative News</h3>
				<div class="card-deck">
					<?php foreach ($newsByCategory as $key=>$value){?>

							<div class="card" style="width: 18rem;">
								<a href="<?=base_url() ?>main/newsDetail/<?=$value['id']?>"><img class="card-img-top img-fluid" src="<?=$value['image']?>" alt="Card image cap"></a>
